...
HD_PWD='C:/Users/Ray/Desktop/DigLogic/lab_2/lab_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Seg.tcl -notrace
