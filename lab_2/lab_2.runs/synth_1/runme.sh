...
HD_PWD='C:/Users/Ray/Desktop/DigLogic/lab_2/lab_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Seg.tcl
