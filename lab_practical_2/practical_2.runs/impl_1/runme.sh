...
HD_PWD='C:/Users/Ray/Desktop/DigLogic/lab_practical_2/practical_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log detector.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source detector.tcl -notrace
