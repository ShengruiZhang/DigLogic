...
HD_PWD='C:/Users/Ray/Desktop/DigLogic/lab_practical_2/practical_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log detector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source detector.tcl
