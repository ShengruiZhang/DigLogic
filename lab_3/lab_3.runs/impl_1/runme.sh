...
HD_PWD='C:/Users/Ray/Desktop/DigLogic/lab_3/lab_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log imp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source imp.tcl -notrace
