...
HD_PWD='C:/Users/Ray/Desktop/DigLogic/lab_3/lab_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log imp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source imp.tcl
