...
HD_PWD='C:/Users/Ray/Desktop/DigLogic/lab_5/proj/lab_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SignExt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SignExt.tcl
