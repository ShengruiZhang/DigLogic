...
HD_PWD='C:/Users/Ray/Desktop/DigLogic-Task_3/lab_5/proj_new/Lab_5_Task_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Datapath_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Datapath_top.tcl
