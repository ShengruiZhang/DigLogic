...
HD_PWD='C:/Users/Ray/Desktop/DigLogic/lab_practical_3/proj/lab_exam.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LabExam.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LabExam.tcl
